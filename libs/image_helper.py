...
def save_image(
    image: FileStorage, folder: str = None, name: str = None
) -> str:
...
def find_image_any_format(filename: str, folder: str) -> Union[str, None]:
    """Takes a filename and returns an image on any of the accepted
    formats.
    """
...
def _retrive_filename(file: Union[str, FileStorage]) -> str:
    """Take FileStorage and returns the file name. Allows our functions to
    call this with both file names and FileStorages and always gets back a
    file name.
    """
